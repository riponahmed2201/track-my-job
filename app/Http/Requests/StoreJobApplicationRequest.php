...
class StoreJobApplicationRequest  extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'application_status' => 'nullable|in:applied,under_review,phone_screen,technical_test,interview,final_interview,offer,accepted,rejected,withdrawn',
            'priority' => 'nullable|in:low,medium,high',
            'source' => 'nullable|string|max:255',
            'referral_contact' => 'nullable|string|max:255',
            'cover_letter_sent' => 'nullable|boolean',
            'portfolio_sent' => 'nullable|boolean',
